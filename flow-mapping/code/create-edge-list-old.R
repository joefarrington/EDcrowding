...
inFile <- paste0("~/EDcrowding/flow-mapping/data-raw/ED_csn_summ_",file_label,"2020-09-28.rda")
load(inFile)

# Load flowsheet data
inFile <- paste0("~/EDcrowding/flow-mapping/data-raw/ED_flowsheets_",file_label,"2020-09-28.rda")
load(inFile)
...
print("Adding additional triage row")
timer <- Sys.time()
...
outFile = paste0("EDcrowding/flow-mapping/data-raw/ED_bed_moves_clean_with_meas_",file_label, today(),".rda")
