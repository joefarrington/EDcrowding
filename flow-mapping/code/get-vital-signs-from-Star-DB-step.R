...
from star.flowsheets a
  join (
          ...
          where department = 'UCH EMERGENCY DEPT'
            and admission > '2019-07-01 00:00:00'
            and admission < '2019-09-01 00:00:00'
         ) c 
    on a.mrn = c.mrn 
    and a.csn = c.csn
    
where a.flowsheet_datetime > '2019-06-30 00:00:00'
and a.flowsheet_datetime < '2019-09-02 00:00:00'"
sqlQuery <- gsub('\n','',sqlQuery)
...
outFile = paste0("EDcrowding/flow-mapping/data-raw/ED_flowsheets_JulAug2019_",today(),".rda")
