...
inFile <- paste0("~/EDcrowding/flow-mapping/data-raw/ED_bed_moves_",file_label,"2020-09-03.rda")
load(inFile)

# Summary for ED CSNs generated by "get-ED-data-from-Star.R"
inFile <- paste0("~/EDcrowding/flow-mapping/data-raw/ED_csn_summ_",file_label,"2020-09-03.rda")
load(inFile)

# Load flowsheet data
inFile <- paste0("~/EDcrowding/flow-mapping/data-raw/ED_flowsheets_",file_label,"2020-09-03.rda")
load(inFile)
