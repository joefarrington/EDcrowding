...
inFile = paste0("EDcrowding/flow-mapping/data-raw/ED_bed_moves_","2020-07-02",".rda")
load(inFile)
...
outFile = paste0("EDcrowding/flow-mapping/data-raw/ED_edge_list_exc_ped_full_",today(),".rda")
