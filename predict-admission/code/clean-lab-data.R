...
lab_real <- merge(lab_real, summ[,.(csn, first_ED_admission, last_ED_discharge)]) 
lab_real <- lab_real[result_last_modified_time <= last_ED_discharge]
...
lab_real <- lab_real[, .(csn, result_last_modified_time, value_as_real, test_lab_code, first_ED_admission, last_ED_discharge, elapsed_mins, oor_low, oor_high)]
