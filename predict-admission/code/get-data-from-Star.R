...
ED_bed_moves_SepOct <- ED_bed_moves %>% ungroup() %>% filter(admission > '2020-08-31')

# original flowsheet and lab data without anything from the months of interest (ie no Sept or Oct)
load("~/EDcrowding/predict-admission/data-raw/flowsheet_raw_2020-11-04.rda")
