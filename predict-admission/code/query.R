...
## currently relying on query from flow-mapping/code and ED_bed_moves processed
# however, I need pk_bed_moves to match with flowsheets
# so as a workaround
...
# write.csv(demog,'F:/UserProfiles/ENOCKUNG/ED project/demog.csv')
save(flowsheet_raw, file = paste0('EDcrowding/predict-admission/data-raw/flowsheet_',today(),'.rda'))
