...
outFile = paste0("EDcrowding/predict-admission/data-output/xgb_results_demo-arrchars-locdurations-counts_60-mins_tune-all-20_1000-trees",today(),".rda")
...
outFile <- paste0("EDcrowding/predict-admission/data-output/xgb_pred_demo-arrchars-locdurations-counts_60-mins_tune-all-20_best-mcc",today(),".rda")
...
save_chart("demo-arrchars-locdurations-counts_60-mins_tune-all-20_best-mcc",
           p + 
             labs(title = "Variable importance after tuning all with 60 min model - best mcc model", 
                  x = "Variable",
                  y = "Importance")
)
# Evaluate results --------------------------------------------------------
